...
view model =
    ...
    in
    myCollage ( 500, 500 )
        [ coloredPetal darkGreen numParts 0 |> move ( -200, 200 )
        , coloredPetal lightGreen numParts 0 |> curveHelper |> move ( -200, 100 )
        , blossomRow4 (coloredPetal lightRed numParts 7) (coloredPetal lightBlue numParts 5) (coloredPetal darkGreen numParts 3) (coloredPetal pink numParts 1)
            |> move ( 0, 0 )
